...
LOCAL_STATIC_LIBRARIES += libtwrpgui libtwrpperf libvold libmounts libotautil libsparse
...
ifneq ($(TW_LOAD_VENDOR_MODULES),)
    ...
    ifneq ($(TW_VENDOR_MODULES_PREPARE_SCRIPT),)
        LOCAL_CFLAGS += -DTW_VENDOR_MODULES_PREPARE_SCRIPT=$(TW_VENDOR_MODULES_PREPARE_SCRIPT)
    endif
